...
public class Page4ChatAdapter extends BaseAdapter {
    ArrayList<Page4MessageItem> messageItems;
    LayoutInflater layoutInflater;

    public Page4ChatAdapter(ArrayList<Page4MessageItem> messageItems, LayoutInflater layoutInflater) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        Page4MessageItem item=messageItems.get(position);
        ...
        Glide.with(itemView).load(item.getPofileiv()).into(iv);
